...
def get_args():
    ...
    parser.add_argument("-kr","--knn_rounds", type=int, default=1, help="Number of KNN rounds")
    parser.add_argument("-kn","--knn_neighbors", type=int, default=4, help="Number of KNN neighbors")
